shader "ForwardAmbientLit" {
    ...
    properties {
        ...
        wrappedDiffuse("Wrapped") : float range 0 1 0.01 = "0.5"
        ...
        heightScale("Height Scale") : float range 0.01 1.0 0.01 = "0.008"
        ...
        _EMISSION_SOURCE("Emission") : enum "None;Texture" = "0" (shaderDefine)
        emissionMap("Emission Map") : object TextureAsset = "_blackTexture"
        emissionColor("Emission Color") : color3 = "1 1 1"
        emissionScale("Emission Scale") : float range 0 100 0.01 = "1"
    }
