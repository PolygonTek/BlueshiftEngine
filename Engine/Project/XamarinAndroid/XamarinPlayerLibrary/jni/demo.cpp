...
#if _ENGINE
extern "C" void	XamarinPlayer_TouchBegin(int32_t touchId, int32_t locationX, int32_t locationY)
{
...
extern "C" void	XamarinPlayer_TouchMove(int32_t touchId, int32_t locationX, int32_t locationY)
{
	uint64_t locationQword = BE1::MakeQWord((int)locationX, (int)locationY);
...
extern "C" void	XamarinPlayer_TouchEnd(int32_t touchId, int32_t locationX, int32_t locationY)
{
	uint64_t locationQword = BE1::MakeQWord((int)locationX, (int)locationY);
...
extern "C" void	XamarinPlayer_TouchCancel(int32_t touchId, int32_t locationX, int32_t locationY)
{
	BE1::platform->QueEvent(BE1::Platform::KeyEvent, BE1::KeyCode::Mouse1, false, 0, NULL);
