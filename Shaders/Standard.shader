shader "Lit/Standard" {
    ...
    properties {
        ...
        metallicMap("Metallic Map") : texture "2D" = "_whiteTexture"
        ...
        roughnessMap("Roughness Map") : texture "2D" = "_whiteTexture"
        ...
        detailNormalMap("Detail Normal Map") : texture "2D" = "_flatNormalTexture"
        detailRepeat("Detail Repeat") : float = "8"
        /*_ANISO("Anisotropy") : enum "None;Value;Texture" = "0" (shaderDefine)
        anisotropyMap("Anisotropy Map") : texture "2D" = "_flatNormalTexture"
        ...
        clearCoatMap("Clear Coat Map") : texture "2D" = "_whiteTexture"
        ...
        clearCoatRoughnessMap("Clear Coat Roughness Map") : texture "2D" = "_whiteTexture"
        ...
        clearCoatNormalMap("Clear Coat Normal Map") : texture "2D" = "_flatNormalTexture"
        ...
        occlusionMap("Occlusion Map") : texture "2D" = "_whiteTexture"
        ...
        emissionMap("Emission Map") : texture "2D" = "_blackTexture"
