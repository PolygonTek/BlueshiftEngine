...
PhysP2PConstraint::PhysP2PConstraint(PhysRigidBody *bodyA, const Vec3 &anchorInA) : 
    ...
    btPoint2PointConstraint *p2pConstraint = new btPoint2PointConstraint(*bodyA->GetRigidBody(), ToBtVector3(anchorInACentroid));
...
void PhysP2PConstraint::SetAnchorA(const Vec3 &anchorInA) {
    ...
    p2pConstraint->setPivotA(ToBtVector3(anchorInACentroid));
}
