...
static BE1::Graphics::Handle mainContext;
static BE1::Graphics::Handle mainRenderTarget;
...
- (void)viewDidAppear:(BOOL)animated {
    mainContext = BE1::graphics.CreateContext((__bridge BE1::Graphics::WindowHandle)self.view, false);
    
    _eaglView = [self.view subviews][0]; // EAGLView
    
    BE1::graphics.SetContextDisplayFunc(mainContext, DisplayContext, NULL, false);
}
...
- (void)initInstance {
    ...
    ::app.Init((__bridge BE1::Graphics::WindowHandle)[rootViewController view]);
