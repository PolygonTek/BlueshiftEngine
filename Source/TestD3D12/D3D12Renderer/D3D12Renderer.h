...
public:
    ...
    virtual void                        ReadPixels(RHI::CommandList *commandList, const RHI::SwapChain *swapChain, int x, int y, int width, int height, BE1::Image::Format::Enum dstFormat, void *outPixels) override;
