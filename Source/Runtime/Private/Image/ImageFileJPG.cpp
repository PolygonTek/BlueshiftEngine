...
bool Image::LoadJPGFromMemory(const char *name, const byte *data, size_t size) {
  ...
  jpeg_mem_src(&cinfo, const_cast<byte *>(data), size);
...
bool Image::WriteJPG(const char *filename, int quality) const {
