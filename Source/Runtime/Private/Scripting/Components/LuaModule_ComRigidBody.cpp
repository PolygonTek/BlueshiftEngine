...
void LuaVM::RegisterRigidBodyComponent(LuaCpp::Module &module) {
    ...
    _ComRigidBody.AddClassMembers<ComRigidBody>(
        ...
        "restitution", &ComRigidBody::GetRestitution,
        "set_restitution", &ComRigidBody::SetRestitution,
        "friction", &ComRigidBody::GetFriction,
        "set_friction", &ComRigidBody::SetFriction,
        "rolling_friction", &ComRigidBody::GetRollingFriction,
        "set_rolling_friction", &ComRigidBody::SetRollingFriction,
        "spinning_friction", &ComRigidBody::GetSpinningFriction,
        "set_spinning_friction", &ComRigidBody::SetSpinningFriction,
        ...
        "is_ccd_enabled", &ComRigidBody::IsCCDEnabled,
        "set_ccd_enabled", &ComRigidBody::SetCCDEnabled,
