...
void LuaVM::RegisterMat3x4(LuaCpp::Module &module) {
    ...
    _Mat3x4.AddClassMembers<Mat3x4>(
        ...
        "mul", static_cast<Vec4(Mat3x4::*)(const Vec4&)const>(&Mat3x4::MulVec),
        "transposed_mul", static_cast<Vec4(Mat3x4::*)(const Vec4&)const>(&Mat3x4::TransposedMulVec),
        "transform_pos", static_cast<Vec3(Mat3x4::*)(const Vec3&)const>(&Mat3x4::TransformPos),
        "transform_dir", static_cast<Vec3(Mat3x4::*)(const Vec3&)const>(&Mat3x4::Mat3x4::TransformDir),
