...
void LuaVM::RegisterVec2(LuaCpp::Module &module) {
    ...
    _Vec2.AddClassMembers<Vec2>(
        ...
        "y", &Vec2::y,
        "at", &Vec2::At,
        "add", static_cast<Vec2(Vec2::*)(const Vec2&)const&>(&Vec2::Add),
        "add_self", &Vec2::AddSelf,
        "sub", static_cast<Vec2(Vec2::*)(const Vec2&)const&>(&Vec2::Sub),
        "sub_self", &Vec2::SubSelf,
        "mul", static_cast<Vec2(Vec2::*)(float)const&>(&Vec2::Mul),
        "mul_self", &Vec2::MulSelf,
        "mul_comp", static_cast<Vec2(Vec2::*)(const Vec2&)const&>(&Vec2::MulComp),
        "mul_comp_self", &Vec2::MulCompSelf,
        "div", static_cast<Vec2(Vec2::*)(float)const&>(&Vec2::Div),
        "div_self", &Vec2::DivSelf,
        "div_comp", static_cast<Vec2(Vec2::*)(const Vec2&)const&>(&Vec2::DivComp),
    ...
    _Vec2.AddClassMembers<Vec2>(
        ...
        "__add", static_cast<Vec2(Vec2::*)(const Vec2&)const&>(&Vec2::Add),
        "__sub", static_cast<Vec2(Vec2::*)(const Vec2&)const&>(&Vec2::Sub),
        "__mul", static_cast<Vec2(Vec2::*)(float)const&>(&Vec2::Mul),
        "__div", static_cast<Vec2(Vec2::*)(float)const&>(&Vec2::Div),
