...
void LuaVM::RegisterVec4(LuaCpp::Module &module) {
    ...
    _Vec4.AddClassMembers<Vec4>(
        ...
        "w", &Vec4::w,
        "at", &Vec4::At,
        "add", static_cast<Vec4(Vec4::*)(const Vec4&)const&>(&Vec4::Add),
        "add_self", &Vec4::AddSelf,
        "sub", static_cast<Vec4(Vec4::*)(const Vec4&)const&>(&Vec4::Sub),
        "sub_self", &Vec4::SubSelf,
        "mul", static_cast<Vec4(Vec4::*)(float)const&>(&Vec4::Mul),
        "mul_self", &Vec4::MulSelf,
        "mul_comp", static_cast<Vec4(Vec4::*)(const Vec4&)const&>(&Vec4::MulComp),
        "mul_comp_self", &Vec4::MulCompSelf,
        "div", static_cast<Vec4(Vec4::*)(float)const&>(&Vec4::Div),
        "div_self", &Vec4::DivSelf,
        "div_comp", static_cast<Vec4(Vec4::*)(const Vec4&)const&>(&Vec4::DivComp),
    ...
    _Vec4.AddClassMembers<Vec4>(
        ...
        "__add", static_cast<Vec4(Vec4::*)(const Vec4&)const&>(&Vec4::Add),
        "__sub", static_cast<Vec4(Vec4::*)(const Vec4&)const&>(&Vec4::Sub),
        "__mul", static_cast<Vec4(Vec4::*)(float)const&>(&Vec4::Mul),
        "__div", static_cast<Vec4(Vec4::*)(float)const&>(&Vec4::Div),
