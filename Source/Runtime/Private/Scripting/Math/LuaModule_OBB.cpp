...
void LuaVM::RegisterOBB(LuaCpp::Module &module) {
    ...
    _OBB.AddClassMembers<OBB>(
        ...
        "volume", &OBB::Volume,
        "translate", static_cast<OBB(OBB::*)(const Vec3&)const&>(&OBB::Translate),
        "translate_self", &OBB::TranslateSelf,
        "rotate", static_cast<OBB(OBB::*)(const Mat3&)const&>(&OBB::Rotate),
        ...
        "expand", static_cast<OBB(OBB::*)(float)const&>(&OBB::Expand),
        ...
        "intersect_ray", static_cast<float(OBB::*)(const Ray&)const>(&OBB::IntersectRay),
