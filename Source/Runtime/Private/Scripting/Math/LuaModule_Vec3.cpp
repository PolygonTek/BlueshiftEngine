...
void LuaVM::RegisterVec3(LuaCpp::Module &module) {
    ...
    _Vec3.AddClassMembers<Vec3>(
        ...
        "z", &Vec3::z,
        "at", &Vec3::At,
        "add", static_cast<Vec3(Vec3::*)(const Vec3&)const&>(&Vec3::Add),
        "add_self", &Vec3::AddSelf,
        "sub", static_cast<Vec3(Vec3::*)(const Vec3&)const&>(&Vec3::Sub),
        "sub_self", &Vec3::SubSelf,
        "mul", static_cast<Vec3(Vec3::*)(float)const&>(&Vec3::Mul),
        "mul_self", &Vec3::MulSelf,
        "mul_comp", static_cast<Vec3(Vec3::*)(const Vec3&)const&>(&Vec3::MulComp),
        "mul_comp_self", &Vec3::MulCompSelf,
        "div", static_cast<Vec3(Vec3::*)(float)const&>(&Vec3::Div),
        "div_self", &Vec3::DivSelf,
        "div_comp", static_cast<Vec3(Vec3::*)(const Vec3&)const&>(&Vec3::DivComp),
    ...
    _Vec3.AddClassMembers<Vec3>(
        ...
        "__add", static_cast<Vec3(Vec3::*)(const Vec3&)const&>(&Vec3::Add),
        "__sub", static_cast<Vec3(Vec3::*)(const Vec3&)const&>(&Vec3::Sub),
        "__mul", static_cast<Vec3(Vec3::*)(float)const&>(&Vec3::Mul),
        "__div", static_cast<Vec3(Vec3::*)(float)const&>(&Vec3::Div),
