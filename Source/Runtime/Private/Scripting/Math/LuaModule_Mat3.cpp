...
void LuaVM::RegisterMat3(LuaCpp::Module &module) {
    ...
    _Mat3.AddClassMembers<Mat3>(
        ...
        "transpose", static_cast<Mat3(Mat3::*)(void)const&>(&Mat3::Transpose),
        "transpose_self", &Mat3::TransposeSelf,
        "inverse", static_cast<Mat3(Mat3::*)(void)const&>(&Mat3::Inverse),
        "inverse_self", &Mat3::InverseSelf,
        "orthonormalize", static_cast<Mat3(Mat3::*)(void)const&>(&Mat3::OrthoNormalize),
