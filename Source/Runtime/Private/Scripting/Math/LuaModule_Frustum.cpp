...
void LuaVM::RegisterFrustum(LuaCpp::Module &module) {
    ...
    _Frustum.AddClassMembers<Frustum>(
        ...
        "up", &Frustum::GetUp,
        "expand", static_cast<Frustum(Frustum::*)(float)const&>(&Frustum::Expand),
        "expand_self", &Frustum::ExpandSelf,
        "translate", static_cast<Frustum(Frustum::*)(const Vec3&)const&>(&Frustum::Translate),
        "translate_self", &Frustum::TranslateSelf,
        "rotate", static_cast<Frustum(Frustum:: *)(const Mat3&)const &>(&Frustum::Rotate),
