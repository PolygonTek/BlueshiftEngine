...
void LuaVM::RegisterMat4(LuaCpp::Module &module) {
    ...
    _Mat4.AddClassMembers<Mat4>(
        ...
        "add", static_cast<Mat4(Mat4::*)(const Mat4&)const&>(&Mat4::Add),
        "add_self", &Mat4::AddSelf,
        "sub", static_cast<Mat4(Mat4::*)(const Mat4&)const&>(&Mat4::Sub),
        ...
        "mul_scalar", static_cast<Mat4(Mat4::*)(float)const&>(&Mat4::MulScalar),
        "mul_scalar_self", &Mat4::MulScalarSelf,
        "mul", static_cast<Vec4(Mat4::*)(const Vec4&)const>(&Mat4::MulVec),
        "transposed_mul", static_cast<Vec4(Mat4::*)(const Vec4&)const>(&Mat4::TransposedMulVec),
        "transform_pos", &Mat4::TransformPos,
        "transform_dir", &Mat4::TransformDir,
        ...
        "set_frustum", static_cast<void(Mat4::*)(float, float, float, float, float, float, bool)>(&Mat4::SetFrustumRH),
        "set_perspective", static_cast<void(Mat4::*)(float, float, float, float, bool)>(&Mat4::SetPerspectiveRH),
        "set_ortho", &Mat4::SetOrthoRH,
        "set_reflect", &Mat4::SetReflect,
        "set_trs", &Mat4::SetTRS,
        "trace", &Mat4::Trace,
        "determinant", &Mat4::Determinant,
        "transpose", static_cast<Mat4(Mat4::*)(void)const&>(&Mat4::Transpose),
        "transpose_self", &Mat4::TransposeSelf,
        "inverse", static_cast<Mat4(Mat4::*)(void)const&>(&Mat4::Inverse),
        "inverse_self", &Mat4::InverseSelf,
        "inverse_affine", static_cast<Mat4(Mat4::*)(void)const&>(&Mat4::InverseAffine),
        "inverse_affine_self", &Mat4::InverseAffineSelf,
        "inverse_orthogonal", static_cast<Mat4(Mat4::*)(void)const&>(&Mat4::InverseOrthogonal),
        "inverse_orthogonal_self", &Mat4::InverseOrthogonalSelf,
        "inverse_orthogonal_uniform_scale", static_cast<Mat4(Mat4::*)(void)const&>(&Mat4::InverseOrthogonalUniformScale),
        "inverse_orthogonal_uniform_scale_self", &Mat4::InverseOrthogonalUniformScaleSelf,
        "inverse_orthogonal_no_scale", static_cast<Mat4(Mat4::*)(void)const&>(&Mat4::InverseOrthogonalNoScale),
        "inverse_orthogonal_no_scale_self", &Mat4::InverseOrthogonalNoScaleSelf,
    ...
    _Mat4.AddClassMembers<Mat4>(
        ...
        "__add", static_cast<Mat4(Mat4::*)(const Mat4 &)const&>(&Mat4::Add),
        "__sub", static_cast<Mat4(Mat4::*)(const Mat4 &)const&>(&Mat4::Sub),
