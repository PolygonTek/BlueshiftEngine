...
void LuaVM::RegisterRect(LuaCpp::Module &module) {
    ...
    _Rect.AddClassMembers<Rect>(
        ...
        "move", static_cast<Rect(Rect::*)(int, int)const&>(&Rect::Move),
        "move_self", &Rect::MoveSelf,
        "shrink", static_cast<Rect(Rect::*)(int, int)const&>(&Rect::Shrink),
        "shrink_self", &Rect::ShrinkSelf,
        "expand", static_cast<Rect(Rect::*)(int, int)const&>(&Rect::Expand),
