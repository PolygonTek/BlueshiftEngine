...
struct avxi {
    ...
    BE_FORCE_INLINE const int32_t &operator[](const size_t index) const { assert(i < 4); return i[index]; }
    BE_FORCE_INLINE int32_t &operator[](const size_t index) { assert(i < 4); return i[index]; }
};
...
BE_FORCE_INLINE avxi operator-(const avxi &a) { return avxi(_mm_sub_epi32(_mm_setzero_si128(), a.l), _mm_sub_epi32(_mm_setzero_si128(), a.h)); }
BE_FORCE_INLINE avxi abs(const avxi &a) { return avxi(_mm_abs_epi32(a.l), _mm_abs_epi32(a.h)); }

//-------------------------------------------------------------
// Binary Operators
//-------------------------------------------------------------

BE_FORCE_INLINE avxi operator+(const avxi &a, const avxi &b) { return avxi(_mm_add_epi32(a.l, b.l), _mm_add_epi32(a.h, a.h)); }
BE_FORCE_INLINE avxi operator+(const avxi &a, const int32_t &b) { return a + avxi(b); }
BE_FORCE_INLINE avxi operator+(const int32_t &a, const avxi &b) { return avxi(a) + b; }

BE_FORCE_INLINE avxi operator-(const avxi &a, const avxi &b) { return avxi(_mm_sub_epi32(a.l, b.l), _mm_sub_epi32(a.h, b.h)); }
BE_FORCE_INLINE avxi operator-(const avxi &a, const int32_t &b) { return a - avxi(b); }
BE_FORCE_INLINE avxi operator-(const int32_t &a, const avxi &b) { return avxi(a) - b; }

BE_FORCE_INLINE avxi operator*(const avxi &a, const avxi &b) { return avxi(_mm_mullo_epi32(a.l, b.l), _mm_mullo_epi32(a.h, b.h)); }
BE_FORCE_INLINE avxi operator*(const avxi &a, const int32_t &b) { return a * avxi(b); }
BE_FORCE_INLINE avxi operator*(const int32_t &a, const avxi &b) { return avxi(a) * b; }
...
BE_FORCE_INLINE avxi operator<<(const avxi &a, const int32_t &n) { return avxi(_mm_slli_epi32(a.l, n), _mm_slli_epi32(a.h, n)); }
BE_FORCE_INLINE avxi operator >> (const avxi &a, const int32_t &n) { return avxi(_mm_srai_epi32(a.l, n), _mm_slli_epi32(a.h, n)); }

BE_FORCE_INLINE avxi sra(const avxi &a, const int32_t &b) { return avxi(_mm_srai_epi32(a.l, b), _mm_srai_epi32(a.h, b)); }
BE_FORCE_INLINE avxi srl(const avxi &a, const int32_t &b) { return avxi(_mm_srli_epi32(a.l, b), _mm_srli_epi32(a.h, b)); }

BE_FORCE_INLINE avxi vmin(const avxi &a, const avxi &b) { return avxi(_mm_min_epi32(a.l, b.l), _mm_min_epi32(a.h, b.h)); }
BE_FORCE_INLINE avxi vmin(const avxi &a, const int32_t &b) { return vmin(a, avxi(b)); }
BE_FORCE_INLINE avxi vmin(const int32_t &a, const avxi &b) { return vmin(avxi(a), b); }

BE_FORCE_INLINE avxi vmax(const avxi &a, const avxi &b) { return avxi(_mm_max_epi32(a.l, b.l), _mm_max_epi32(a.h, b.h)); }
BE_FORCE_INLINE avxi vmax(const avxi &a, const int32_t &b) { return vmax(a, avxi(b)); }
BE_FORCE_INLINE avxi vmax(const int32_t &a, const avxi &b) { return vmax(avxi(a), b); }
...
BE_FORCE_INLINE avxb operator==(const avxi &a, const avxi &b) { return avxb(_mm_castsi128_ps(_mm_cmpeq_epi32(a.l, b.l)), _mm_castsi128_ps(_mm_cmpeq_epi32(a.h, b.h))); }
BE_FORCE_INLINE avxb operator==(const avxi &a, const int32_t &b) { return a == avxi(b); }
BE_FORCE_INLINE avxb operator==(const int32_t &a, const avxi &b) { return avxi(a) == b; }

BE_FORCE_INLINE avxb operator!=(const avxi &a, const avxi &b) { return !(a == b); }
BE_FORCE_INLINE avxb operator!=(const avxi &a, const int32_t &b) { return a != avxi(b); }
BE_FORCE_INLINE avxb operator!=(const int32_t &a, const avxi &b) { return avxi(a) != b; }

BE_FORCE_INLINE avxb operator<(const avxi &a, const avxi &b) { return avxb(_mm_castsi128_ps(_mm_cmplt_epi32(a.l, b.l)), _mm_castsi128_ps(_mm_cmplt_epi32(a.h, b.h))); }
BE_FORCE_INLINE avxb operator<(const avxi &a, const int32_t &b) { return a < avxi(b); }
BE_FORCE_INLINE avxb operator<(const int32_t &a, const avxi &b) { return avxi(a) < b; }
...
BE_FORCE_INLINE avxb operator>(const avxi &a, const avxi &b) { return avxb(_mm_castsi128_ps(_mm_cmpgt_epi32(a.l, b.l)), _mm_castsi128_ps(_mm_cmpgt_epi32(a.h, b.h))); }
BE_FORCE_INLINE avxb operator>(const avxi &a, const int32_t &b) { return a > avxi(b); }
BE_FORCE_INLINE avxb operator>(const int32_t &a, const avxi &b) { return avxi(a) > b; }
...
BE_FORCE_INLINE avxi select(const avxb &mask, const avxi &a, const avxi &b) {
...
BE_FORCE_INLINE avxi vreduce_min2(const avxi &v) { return vmin(shuffle<1, 0, 3, 2>(v), v); }
BE_FORCE_INLINE avxi vreduce_min4(const avxi &v) { avxi h = vreduce_min2(v); return vmin(shuffle<2, 3, 0, 1>(h), h); }
BE_FORCE_INLINE avxi vreduce_min(const avxi &v) { avxi h = vreduce_min4(v); return vmin(shuffle<1, 0>(h), h); }

BE_FORCE_INLINE avxi vreduce_max2(const avxi &v) { return vmax(shuffle<1, 0, 3, 2>(v), v); }
BE_FORCE_INLINE avxi vreduce_max4(const avxi &v) { avxi h = vreduce_max2(v); return vmax(shuffle<2, 3, 0, 1>(h), h); }
BE_FORCE_INLINE avxi vreduce_max(const avxi &v) { avxi h = vreduce_max4(v); return vmax(shuffle<1, 0>(h), h); }

BE_FORCE_INLINE avxi vreduce_add2(const avxi &v) { return shuffle<1, 0, 3, 2>(v) + v; }
BE_FORCE_INLINE avxi vreduce_add4(const avxi &v) { avxi h = vreduce_add2(v); return shuffle<2, 3, 0, 1>(h) + h; }
BE_FORCE_INLINE avxi vreduce_add(const avxi &v) { avxi h = vreduce_add4(v); return shuffle<1, 0>(h) + h; }
